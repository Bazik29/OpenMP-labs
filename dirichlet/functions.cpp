...
void printCSV_dir(int threads, size_t dim, double eps, size_t IterCnt, double runtimeDuration) {
	cout << threads << "," << dim << "," << eps << "," << IterCnt << runtimeDuration << endl;
}
...
DirichletResult solveDirichlet_wave(size_t N,  double eps) {
